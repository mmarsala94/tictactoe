...
//}
  ...
  if (boardModel.playerWinSimple() === 'X') {
    console.log("Hey");
    bestPointBoard.rowWhereMoveMade = -1;
    bestPointBoard.colWhereMoveMade = -1;
    ...
    for (var j = 0; j < boardModel.columnTotal; j++) {
      ...
      if (isMaximizingPlayer) {
        ...
        if (isValidMove) {
          ...
          var tempPointBoard = getBestOutcome(tttModel,!isMaximizingPlayer);
        ...
        if (isValidMove) {
          ...
          if (tempPointBoardq.pointValue < bestPointBoard.pointValue) {
...
console.log(getBestOutcome(tttModel4, false));
